...
<div class="title">
<br><br><br>
<h2 style="font-weight: bold;color:black;">DOAÇÕES RECEBIDAS ARQUIVADAS</h2> 
<hr>
</div>
</div>
<div class="row">
...
<a href="pesquisa-recedoacao.php?value=0"><button type="button"   style="padding-left:40px;" class="button icon-archive">Ver doações ativas</button></a>
<br>
<br>
...
<td><a href="restaurar-doacaorece.php?id=<?php echo $entrada['idEntradaDoacao'] ?>"><button type="button"  style="padding-left:40px;" class="button icon-archive">Restaurar</button></a>  </td>   
	<td><a href="excluir-doacaorece.php?id=<?php echo $entrada['idEntradaDoacao'] ?>" onclick="return confirm('Deseja realmente excluir?')" style="padding-left:40px;" ><button style="padding-left:40px;" type="button" class="button icon-delete2">Excluir</button></a></td> 
</tr>
